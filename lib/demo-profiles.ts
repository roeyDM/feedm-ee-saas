...
export const DEMO_PROFILES: Record<string, DemoProfileData> = {
  ...
  "fitgym-studio": {
    ...
    bio: "Premier Fitness & Personal Training Studio 🏋️‍♂️ Transform your health with expert trainers.",
    themeColor: "#10b981",
    ...
    links: [
      {
        id: "fit-1",
        title: "Claim Your Free 7-Day Trial Workout Pass 🏋️‍♂️",
        url: "/pricing",
        badgeText: "FREE PASS",
        isActive: true,
      },
  ...
  "aura-apparel": {
    ...
    links: [
      {
        id: "aura-1",
        title: "Shop Summer Collection Drop 🛍️",
        url: "/pricing",
        badgeText: "NEW DROP",
        isActive: true,
      },
      {
        id: "aura-2",
        title: "Get 15% Off Your First Order 🏷️",
        url: "/pricing",
