...
export function renderSubscriptionActiveHtml(props: SubscriptionActiveEmailProps): string {
  return `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"/><title>Payment Confirmed — Welcome to Feedm.ee ${props.planName || "Pro Plan"}</title></head>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width:560px;background-color:#ffffff;border-radius:24px;border:1px solid #e5e7eb;overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px;">
              ...
              <h1 style="font-size:20px;font-weight:800;color:#09090b;margin:0 0 16px;">Payment Confirmed — Welcome to Feedm.ee ${props.planName || "Pro Plan"}</h1>
