...
function RegisterForm() {
  ...
  return (
    <div className="min-h-dvh w-full max-w-full overflow-x-hidden overflow-y-auto relative flex flex-col items-center justify-center bg-gradient-to-br from-amber-50/60 via-emerald-50/40 to-sky-50/50 px-4 py-4 sm:py-6 text-zinc-900 font-sans">
      ...
      <div className="relative w-full max-w-md mx-auto z-10 my-auto">
        {/* Dynamic Plan Badge */}
        <div className="mb-3 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/90 border border-emerald-300 shadow-xs px-3.5 py-1 text-xs font-bold text-emerald-950 backdrop-blur-md">
        ...
        <div className="mb-4 flex flex-col items-center text-center">
          <Link href="/" className="mb-2 flex items-center justify-center p-1.5 rounded-2xl bg-white shadow-xs border border-zinc-200/80 hover:scale-105 transition-transform">
            <LogoIconOnly />
          </Link>
          <h1 className="text-xl font-black text-zinc-950 tracking-tight sm:text-2xl">
        ...
        {/* Card */}
        <div className="rounded-3xl border border-zinc-200/90 bg-white/95 p-5 sm:p-6 shadow-2xl shadow-zinc-900/5 backdrop-blur-md">
          {error && (
            <div className="mb-4 flex items-center gap-2 rounded-xl bg-rose-50 border border-rose-200 p-2.5 text-xs font-bold text-rose-700">
