            ...
            <form onSubmit={handleVerify2FA} className="space-y-4">
              <div className="p-3 rounded-2xl bg-violet-50 border border-violet-200 text-violet-950 flex items-center gap-3">
                ...
                <p className="text-xs font-semibold leading-relaxed">
                  Two-Factor Protection Active. Please enter the TOTP code generated by your authenticator app.
                </p>
              </div>

              <div className="space-y-1">
                <label className="text-xs font-bold text-zinc-700">Verification Code</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="123456"
                    className="w-full rounded-xl border border-zinc-200 bg-zinc-50 py-2.5 pl-10 pr-4 text-base tracking-widest font-mono text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 text-center"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full text-center text-xs font-bold text-zinc-500 hover:text-zinc-900 transition pt-2 cursor-pointer"
              >
